#
#  Be sure to run `pod spec lint BankConnect.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "BankConnect IOS SDK to enable BankConnect journey for IOS devices"
  ...
  spec.source       = { :git => "git@gitlab.com:finbox/bankconnect/mobile/ios-bank-connect.git", :tag => "#{spec.version}" }
